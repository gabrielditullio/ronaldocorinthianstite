...
import { Users, TrendingUp, DollarSign, Target, CalendarCheck, BarChart3 } from "lucide-react";
...
export function DashboardKPIs({
  ...
  const stats = useMemo(() => {
    ...
    return { leadsGenerated, meetingsScheduled, meetingsCompleted, sales, revenue, netRevenue, conversionRate, showRate, avgTicket, prevRevenue, prevNetRevenue, prevLeads, prevConversion, prevShowRate, prevSales };
  }, [kpiAgg, prevKpiAgg]);
