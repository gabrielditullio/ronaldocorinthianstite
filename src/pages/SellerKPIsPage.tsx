  ...
  const renderPerformanceCards = () => {
    if (isSdr) {
      return (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <Card><CardHeader className="pb-2"><CardTitle className="text-sm font-medium text-muted-foreground flex items-center gap-2"><Target className="h-4 w-4" />Qualificação</CardTitle></CardHeader><CardContent><p className="text-2xl font-bold">{totals.leads_qualified}</p><p className="text-xs text-muted-foreground">Taxa: {sdrQualRate.toFixed(1)}%</p><div className="mt-1"><MoMIndicator current={totals.leads_qualified} previous={prevTotals?.qualified ?? null} format={v => String(v)} /></div></CardContent></Card>
          <Card><CardHeader className="pb-2"><CardTitle className="text-sm font-medium text-muted-foreground flex items-center gap-2"><Calendar className="h-4 w-4" />Agendamento</CardTitle></CardHeader><CardContent><p className="text-2xl font-bold">{totals.meetings_scheduled}</p><p className="text-xs text-muted-foreground">Taxa: {sdrSchedulingRate.toFixed(1)}%</p><div className="mt-1"><MoMIndicator current={totals.meetings_scheduled} previous={prevTotals?.meetings_scheduled ?? null} format={v => String(v)} /></div></CardContent></Card>
    ...
    if (isCloser) {
      return (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
          ...
          <Card><CardHeader className="pb-2"><CardTitle className="text-sm font-medium text-muted-foreground flex items-center gap-2"><DollarSign className="h-4 w-4" />Receita</CardTitle></CardHeader><CardContent><p className="text-2xl font-bold">R$ {totals.net_revenue.toLocaleString("pt-BR", { minimumFractionDigits: 0 })}</p><div className="mt-1"><MoMIndicator current={totals.net_revenue} previous={prevTotals?.net_revenue ?? null} format={v => `R$ ${v.toFixed(0)}`} /></div></CardContent></Card>
    ...
    return (
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card><CardHeader className="pb-2"><CardTitle className="text-sm font-medium text-muted-foreground flex items-center gap-2"><DollarSign className="h-4 w-4" />Faturamento</CardTitle></CardHeader><CardContent><p className="text-2xl font-bold">R$ {totals.revenue.toLocaleString("pt-BR", { minimumFractionDigits: 0 })}</p><div className="mt-1"><MoMIndicator current={totals.revenue} previous={prevTotals?.revenue ?? null} format={v => `R$ ${v.toFixed(0)}`} /></div></CardContent></Card>
      </div>
    );
  };
